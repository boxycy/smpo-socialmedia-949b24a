...
$(function() {
  ...
  function set_settings() {
	...
	// The avatar images used in the online preview of the paradigm were created using by https://getavataaars.com and due to their terms not available for redistribution. You should therefore create your own images. All images should be 250x250 pixels in size and carry the names "avatar_NUMBER.png" (e.g. avatar_1.png; "png" should be lower case; the numbers in the names should be consequtive, starting from 1). The number of avatars dependeds on the corresponding parameter. The images should be placed in folder "avatars," located in the main study folder extracted on your computer or server.
    ...
    settings.defaultredirect = 'return.html';
    ...
    settings.likes_by = ['John','AncaD','Sarah','Arjen','Jane','George','Hannah','Ky','Nick']; 
  }
